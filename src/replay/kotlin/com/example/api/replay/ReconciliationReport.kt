    ...
    private val RECORD_GRANULARITY_NOTES =
        listOf(
            "**「一周完了」はモデルが事実に耐えたことを意味しない。**" +
                "非公開項目を合成で埋め、内国産馬を輸入馬として登録して通しているため、" +
            ...
            "JBIS-Search の繁殖成績の年軸は産駒の生年であり、種付年ではない。" +
                "各フィクスチャの種付年（種付なしの年は繁殖年）は生年から 1 を引いて求めた近似値である。" +
                "とくに種付なしの年は産駒も種付も存在しないため、この換算が妥当かは公開記録からは判別できない。",
