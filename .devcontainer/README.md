...
コンテナ内プロセスが任意の外部へ通信できる状態を絞る（[issue #304](https://github.com/ptiringo/toy-box/issues/304) / [ADR-0035](../docs/adr/0035-devcontainer-egress-firewall.md)）。
...
- ~~**ネットワーク firewall サンドボックス**~~ → #304 / ADR-0035 で導入済み（上記「ネットワーク egress firewall」参照）。
